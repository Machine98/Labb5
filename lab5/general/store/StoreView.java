...
public class StoreView extends View {
    ...
    public void lastPrint(){
        ...
        System.out.println("\tGenomsnittlig ledig kassa tid " + String.format("%.2f",storeState.getUnoccupiedRegTime()/storeState.getRegisters()) + " (dvs " + String.format("%.2f",((storeState.getUnoccupiedRegTime()/storeState.getTotAmQueue())/storeState.getLastEventTime())*100) + " % " + "av tiden från öppning tills sista kunden betalat" + ".");
        System.out.println("");
